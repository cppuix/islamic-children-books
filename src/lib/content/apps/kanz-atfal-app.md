...
A progressive web app (PWA) for studying Islamic creed through question-and-answer flashcards, built around two educational texts: _Muntaqā Kanz al-Aṭfāl_ (a concise summary) and _Kanz al-Aṭfāl_ (the full book), both by Dr. Fayṣal bnu Misfir al-Wādiʿī. The app currently offers the Arabic text of both books and the English translation of the full Kanz, with more translations planned.
...
- Any question you get wrong more often than right gets flagged as a weak spot, and a dedicated _Weak Spots_ section appears in the chapter selector so you can drill exactly what needs work.
