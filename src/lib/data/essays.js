// src/lib/data/essays.js
//
// Curation: his own writings only. Deliberately excluded:
//  - introduction                        → that's the About page (the manifesto)
//  - mind-expansion-in-a-chain-of-awe    → lives verbatim inside "you-cant-pass-on-..."
//  - shared/forwarded pieces             → Gentleness, Understanding the Nature of
//    Children, Stop complaining to the people!, The Prophet ﷺ Kissed His Grandsons,
//    A glimpse of the reverence for the Sunnah...
//  - book/app landing pages              → The Treasure Of Children, Islamic Creed
//    Learning App, Vocabulary Harvest..., How Abu Bakr..., Discover How Abu Bakr...
//
// `id` = the slug of the markdown file the script generates in src/lib/content/
